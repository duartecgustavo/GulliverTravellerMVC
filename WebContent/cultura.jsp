...
<link rel="stylesheet" href="./assets/css/redesSociais.css">
    ...
    <title>Gulliver Traveller - Cultura e Gastronomia</title>
</head>
...
<body class="container">
    ...
    <main class="mt-5 mb-5">
        ...
        <div class="">
            ...
            <div>
                <h1 class="text-center">Cultura e Gastronomia</h1>

            </div>
            <div class="gallery js-flickity my-5" data-flickity-options='{ "wrapAround": true }'>
                <div><img src="./assets/images/cultura/Frame 1.png" alt="Foto moça"></div>
            ...
            <h3 class="text-center ">Para curtir sua viagem, nada melhor que diversão acompanhada <br> de uma boa
                comida,pensado nisso fizemos esse guia de <br> gastronomia e cultura
            </h3>
            <div style="background: #D9D9D9;">
                <div>
                    <h4>Melhores Restaurantes</h4>
                </div>
                <div class="container text-center mb-5">
                    <div class="row g-2">
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img
                                    src="./assets/images/cultura/a-casa-do-porco.png" class="img-fluid"
                                    alt="Casa dos porcos">
                                <ul class="list-inline">
                                    <li class="list-inline-item">A casa do porco</li>
                                    <li class="list-inline-item">São Paulo - SP<i class=""></i></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img src="./assets/images/cultura/Mocotó.png"
                                    class="img-fluid" alt="Mocoto">
                                <ul class="list-inline">
                                    <li class="list-inline-item">Mocotó</li>
                                    <li class="list-inline-item">São Paulo - SP<i class=""></i></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img src="./assets/images/cultura/origem.png"
                                    class="img-fluid" alt="Origem">
                                <ul class="list-inline">
                                    <li class="list-inline-item">Origem</li>
                                    <li class="list-inline-item">Salvador - BA<i class=""></i></li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img src="./assets/images/cultura/mani.png"
                                    class="img-fluid" alt="Mani">
                                <ul class="list-inline">
                                    <li class="list-inline-item">Mani</li>
                                    <li class="list-inline-item">São Paulo - SP<i class=""></i></li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="" style="background: #D9D9D9;">
                ...
                <div class="container text-center mb-5">
                    <div class="row g-2">
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img
                                    src="./assets/images/cultura/manaus-teatro-amazonas.png" class="img-fluid" alt="Teatro">
                                <ul class="list-inline">
                                    <li class="list-inline-item">Manaus / AM</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img
                                    src="./assets/images/cultura/sao_paulo.png" class="img-fluid" alt="São Paulo">
                                <ul class="list-inline">
                                    <li class="list-inline-item">São Paulo / SP</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img
                                    src="./assets/images/cultura/1-cristo-redentor.png" class="img-fluid" alt="Rio">
                                <ul class="list-inline">
                                    <li class="list-inline-item">Rio de Janeiro / RJ</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-3">
                            <div class="p-3 border-transparent bg-transparent"><img
                                    src="./assets/images/cultura/portoseguro-vidasemparedes-20-1024x768.png"
                                    class="img-fluid" alt="Porto Seguro">
                                <ul class="list-inline">
                                    <li class="list-inline-item">Porto Seguro /BA</li>
                                </ul>
                            </div>
                        </div>
                    </div>
